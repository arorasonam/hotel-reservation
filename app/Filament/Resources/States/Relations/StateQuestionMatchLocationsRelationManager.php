...
class StateQuestionMatchLocationsRelationManager extends RelationManager
{
    ...
    {
        return QuestionMatchLocationResource::table($table)->headerActions([
            CreateAction::make()
                ->fillForm(fn(): array => [
                    'locationable_id' => $this->getOwnerRecord()->id,
                    'locationable_type' => State::class,
                ]),
        ]);
    }
}
